  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        <a href="https://wa.me/34623944937" target="_blank" rel="noreferrer"
      ...
      <select style={{ fontFamily: fonts.body, fontSize: 14, fontWeight: 600, background: '#fff', border: `1px solid ${colors.ink}`, padding: '8px 12px', borderRadius: 2 }}>
        <option>CA</option><option>ES</option><option>EN</option><option>FR</option>
      </select>
    </nav>
  );
}
