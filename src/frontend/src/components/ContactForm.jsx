...
// ↓ Foto de sobre de "Contacta". Posa la imatge a src/recursos/ amb aquest nom
//   (o canvia el nom aquí). Mentre el fitxer no existeixi, Vite donarà error.
import furgoneteo from '../recursos/furgoneteo.jpg';
